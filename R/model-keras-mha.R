...
.k3_multiheadattention <- function(
  ...
  cli::cli_warn(
    c(
      "MultiHeadAttention {.val {lname}}: {.code use_causal_mask} is a call-time argument in Keras 3 and is not saved in the layer config.",
      "i" = "If this layer was called with {.code use_causal_mask = TRUE}, orbital cannot enforce the causal mask and predictions will be incorrect.",
