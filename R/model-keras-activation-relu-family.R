# Standalone ReLU-family activation layer handlers:
#   .k3_prelu()     - per-channel learnable PReLU
#   .k3_leakyrelu() - LeakyReLU (negative_slope from config)
#   .k3_elu()       - ELU (alpha from config)
#   .k3_relu()      - generic ReLU(threshold, negative_slope, max_value)
