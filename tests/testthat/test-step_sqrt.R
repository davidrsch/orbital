...
test_that("spark - step_sqrt works", {
  skip_if_not_installed("recipes")
...
test_that("SQLite - step_sqrt works", {
  skip_if_not_installed("recipes")
...
test_that("arrow - step_sqrt works", {
  skip_if_not_installed("recipes")
...
test_that("estimate_step_chars works for step_sqrt", {
  skip_if_not_installed("recipes")
...
test_that("estimate_step_chars works for step_sqrt with empty selection", {
  skip_if_not_installed("recipes")
